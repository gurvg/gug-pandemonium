...
public class ForumMsgListActivity extends ListActivity {
	
	private List<Message> messages;
	static String feedUrl = "http://www.pandemonium-varimathras.fr/forum/feed.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new ProgressTask(ForumMsgListActivity.this).execute(feedUrl);
    ...
    public void BtnHomeEvent(View v)
  	{       
    	...
    	launchNewIntent = new Intent( ForumMsgListActivity.this,HomeActivity.class);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent intent = new Intent(ForumMsgListActivity.this, ForumMsgDetailActivity.class);
	    ...
	    class ProgressTask extends AsyncTask<String, Void, Boolean> {
	        ...
	        /** application context. */
	        private ForumMsgListActivity activity;
	    	
	    	public ProgressTask(ForumMsgListActivity activity) {
