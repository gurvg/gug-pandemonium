...
public class RaidActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new ProgressTask(RaidActivity.this).execute(url);
    ...
    public void BtnHomeEvent(View v)
  	{       
    	...
    	launchNewIntent = new Intent( RaidActivity.this,HomeActivity.class);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		String selected_raidname = raidList.get(position).get("raidname");
		Bundle bundle = new Bundle();
		bundle.putString("raidname", selected_raidname);
		bundle.putSerializable("bosslist", bossListFilter(selected_raidname));
		
		Intent intent = new Intent(RaidActivity.this, BossActivity.class);
	...
	private ArrayList<HashMap<String, String>> bossListFilter(String raidname)
	{
		ArrayList<HashMap<String, String>> _bossListFilter;
		_bossListFilter = new ArrayList<HashMap<String, String>>();
		
		 for (HashMap<String, String> v : bossList)
		 {
			 if(v.get("raidname").equals(raidname))
			 {				 
				  // creating new HashMap
                 HashMap<String, String> map = new HashMap<String, String>();
                   
                 map.put("raidname", v.get("raidname"));
                 map.put("bossname", v.get("bossname"));  
                 map.put("kills", v.get("kills"));
                 map.put("time", v.get("time"));
                
                 // adding HashList to ArrayList
                 _bossListFilter.add(map);
				 
			 }
			 
		 }
		 		
		return _bossListFilter;
	}
    ...
    class ProgressTask extends AsyncTask<String, Void, Boolean> {
        ...
        /** application context. */
        private RaidActivity activity;
    	
    	public ProgressTask(RaidActivity activity) {
